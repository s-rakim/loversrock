...
export const MOODS = [
  ...
  { id: 'gloomy', label: 'Gloomy', icon: 'rainy-outline' },
  { id: 'weepy', label: 'Weepy', icon: 'water-outline' },
  { id: 'drained', label: 'Drained', icon: 'battery-half-outline' },
  { id: 'touchy', label: 'Touchy', icon: 'alert-circle-outline' },
  { id: 'needy', label: 'Needy', icon: 'hand-left-outline' },
  { id: 'affectionate', label: 'Affectionate', icon: 'heart-circle-outline' },
  { id: 'content', label: 'Content', icon: 'checkmark-circle-outline' },
